...
public class EventTestController {
    ...
    public void createEvent() throws Exception {
        ...
        .andExpect(header().exists(HttpHeaders.LOCATION)) // return value id가 존재하는지
        .andExpect(header().string(HttpHeaders.CONTENT_TYPE, MediaTypes.HAL_JSON_UTF8_VALUE)); // return value id가 존재하는지
